      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Grille Salariale</h1>
          ...
          <div class="mb-4" >
          <hr>  </hr>
          <h6> <lead> Apres Un An </lead> </h6>
              <canvas  id="un" ></canvas>
          </div>
          <div class="mb-4" >
          <hr>  </hr>
          <h6> <lead> Apres 3 Ans </lead> </h6>
              <canvas  id="trois" ></canvas>
          </div>
</div>
...
var trois = new Chart(tr, {
    type: 'pie',
    data: {
        labels: ["-500000", "[500k-1.2M]", "+1.2 Millions"],
        datasets: [{
            label: '# of Votes',
            backgroundColor: ['rgba(255,99,132,1)',
                'rgba(54, 162, 235, 1)',

  ...
  <div class="collapse" id="navbarToggleExternalContent">
    ...
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        ...
        <a class="p-2 text-light " href="../acceuil/">Acceuil <span class="sr-only">(current)</span></a> </a>
...
?> </br> Merci d'avoir participé a notre enquete sur les statistiques des anciens STIC.</br>  Votre contribution permettra  d'améliorer la formation de vos cadets  </p>
  <hr>
  <p class="mb-0">Voulez vous Statitique? <a href="../dashboard/" class="alert-link">Statistiques</a> etes vous deja inscrit vous pouvez egalement modifier vos info <a href="../loginmodifier/index.html" class="alert-link">modifier</a> </p>
</div>
      </div>
